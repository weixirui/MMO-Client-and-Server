...
public enum PacketType {
	PLAYER_CHARACTER_PACKET((byte) 15), EXTENSIVE_CHARACTER_PACKET((byte) 14), EXTENSIVE_OBJECT_PACKET((byte) 12), ENTITY_UPDATE_PACKET((byte) 7), ENTITY_CLICK_PACKET((byte) 5), INTERFACE_CLICK_PACKET((byte) 12), USER_STATUS_PACKET((byte) 10), SERVER_MODULE_STATUS_PACKET((byte) 9), ADMIN_COMMAND_PACKET(
	...
	//Currently unused bytes: 11, 30-255
