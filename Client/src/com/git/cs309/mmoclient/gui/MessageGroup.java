...
public enum MessageGroup {
	ALL((byte) 100, Color.WHITE), PRIVATE(MessagePacket.PRIVATE_CHAT, Color.PINK), PARTY(MessagePacket.PARTY_CHAT,
			Color.BLUE), GLOBAL(MessagePacket.GLOBAL_CHAT, Color.ORANGE), LOCAL(MessagePacket.LOCAL_CHAT, Color.WHITE);
