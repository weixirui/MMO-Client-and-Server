...
public final class MapDefinition implements Serializable {
	...
	public MapDefinition(final String mapName, final int xOrigin, final int yOrigin, final int z, final int width, final int height, final Collection<Spawn> spawns) {
	...
	public boolean equals(Object other) {
		...
		return map.xOrigin == xOrigin && map.yOrigin == yOrigin && map.z == z && map.width == width && map.height == height;
	}
